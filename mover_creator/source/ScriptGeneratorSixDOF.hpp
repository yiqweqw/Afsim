...
#ifndef SCRIPT_GENERATOR_SIXDOF_HPP
#define SCRIPT_GENERATOR_SIXDOF_HPP
...
namespace Designer
{
   ...
   class ScriptGeneratorSixDOF : public ScriptGenerator
   {
      public:
         ScriptGeneratorSixDOF() = default;
         ~ScriptGeneratorSixDOF() = default;

         void CreateFolderStructure() override;

         virtual QString GetFilenameSuffix() = 0;
         ...
         virtual void CreateAutopilotG_LimitConfigFile(QString& aControlsDir);

      protected:

         virtual AeroEngine::ExportMoverType GetMoverType() = 0;
         virtual QString GetDefaultIntegratorName() = 0;
         virtual QString GetScriptMoverType() = 0;

         void CreateBaseScenarioFile();
         void CreateSignaturesFile();

         virtual void CreateEnvironmentFiles();
         ...
         void Create2dTableFile(const QString& aAeroDir, AeroTable2d* aTablePtr);
...
#endif //SCRIPT_GENERATOR_SIXDOF_HPP
