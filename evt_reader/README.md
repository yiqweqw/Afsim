...
The Event Reader tool is an application that can read and display AFSIM-Mission event_output (.evt) files that contain time-stamped events in a human readable format.

Maintained by USAF - AFRL/RQQD with support from Infoscitex, a DCS Company.
